...
# ================================================================================================================
# Description:
# This script automates the installation of AMD ROCm 6.4.3, PyTorch 2.9.0 (nightly build), Transformers, and Docker
...
# ---------------------------------------------------------------------------------------------------------------
# ROCm Platform:         6.4.3
# ROCm Release Notes:    https://rocm.docs.amd.com/en/docs-6.4.3/about/release-notes.html
# ROCm Driver Repo:      https://repo.radeon.com/amdgpu-install/6.4.3/ubuntu/
#
...
install_focal() {
    print '\nUbuntu 20.04.x (focal) is not longer be supported for ROCm 6.4.3. The last supported version is ROCm 6.4.0.\n'
...
install_jellyfish() {
    ...
    sudo DEBIAN_FRONTEND=noninteractive apt install -y ./amdgpu-install_6.4.60403-1_all.deb

    # Installing multiple use cases including ROCm 6.4.3, OCL and HIP SDK

    print '\nInstalling ROCm 6.4.3 + OCL 2.x environment ...\n'
...
printf "\nFinished ROCm 6.4.3 + OCL 2.x + PyTorch 2.9.0 (nightly build) + Transformers environment installation and setup.\n"
